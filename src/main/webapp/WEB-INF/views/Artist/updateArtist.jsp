...
<body>
	...
	<h2 style="text-align: center">Update Artist</h2>
	<br>
	<div style="margin-left: 600px;">
		<form:form modelAttribute="artist"
			...
			<table>
				...
				<tr>
					<td>FirstName:</td>
					<td><form:input path="firstName" value="${artist.firstName }" />
					</td>
					<td><form:errors path="firstName" cssStyle="color:red" /></td>
				</tr>
				<tr>
					<td>LastName:</td>
					<td><form:input path="lastName" value="${artist.lastName }" />
					</td>
				...
				<tr>
					...
					<td><form:input path="dateOfBirth"
							value="${artist.dateOfBirth }" /></td>
					<td><form:errors path="dateOfBirth" cssStyle="color:red" /></td>
				</tr>
				<tr>
					<td>Place of Birth:</td>
					<td><form:input path="placeOfBirth"
							value="${artist.placeOfBirth }" /></td>
				...
				<tr>
					<td>Biography:</td>
					<td><form:input path="biography" value="${artist.biography }" />
					</td>
